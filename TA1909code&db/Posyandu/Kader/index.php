<?php 
    session_start();
    if(empty($_SESSION['userid']) || $_SESSION['lev'] != "Kader"){
...
<html lang="en">
    <head>
        <base href="http://localhost/posyandu/kader/">                     
