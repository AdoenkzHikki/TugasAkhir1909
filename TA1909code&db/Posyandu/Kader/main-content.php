    ...
    <div class="container">
        <div class="block block-condensed">
            <div style="margin-top:30px">
                ...
                <h1 style="text-align:center">Kelurahan Pasarbatang Kabupaten Brebes</h1>
            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="block">                        
                            ...
                            <form class="form-horizontal" method="post" name="frinput">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Konfirmasi Password Baru</label required>
                                    <div class="col-md-3">
                            ...
                            <?php 
                                ...
                                if(isset($_POST['btnsimpan'])){
                                        ...
                                        if($konfirpass == $pass){
                                            ...
                                            echo "<script>confirm('Password yang Anda masukkan belum sama')</script>";
                                        }
