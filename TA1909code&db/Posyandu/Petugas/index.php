<?php 
    session_start();
    if(empty($_SESSION['userid']) || $_SESSION['lev']!="Petugas Kesehatan"){
...
<html lang="en">
    <head>                        
        <base href="http://localhost/posyandu/petugas/">    
                ...
                <div class="app-content app-sidebar-left">
                    ...
                    <?php
                        ...
                        if($_GET['page']==""){
                            ...
                            include 'dataimunisasi-file.php';
                        }else if($_GET['page']=="edit-imunisasi"){
                            include 'dataimunisasi-file.php';
                        }else if($_GET['page']=="datavitamin"){
                            include 'datavitamin-file.php';
