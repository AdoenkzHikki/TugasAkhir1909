...
<?php } 
    ...
    <div class="container">
                        ...
                        <?php
                            ...
                            $bb = mysqli_query($koneksi,"select bulan,berat_badan from tb_anak where bulan='januari'");
                            $tb = mysqli_query($koneksi,"select bulan,tinggi_badan from tb_anak where bulan='februari'");
                        ...
                        <script  type="text/javascript">
                            ...
                            var data = {
                                        ...
                                        data: [<?php while ($p = mysqli_fetch_array($bb)) { echo '"' . $p['berat_badan'] . '"';}?>]
                                        },
                                    {
                                        label: "Tinggi Badan",
                                        fill: false,
                                        ...
                                        data: [<?php while ($p = mysqli_fetch_array($tb)) { echo '"' . $p['tinggi_badan'] . '"';}?>]
                                        }
                                    ]
                                    };
